...
--Tablas unicamente con primary key
...
CREATE TABLE [dbo].[DocentesEstudiantes] (
    ...
    [EstudianteId] int NOT NULL Constraint FK_Estudiante_DocentesEstudiantes Foreign Key References dbo.Estudiantes(id),
    [Estado] bit default 1,
